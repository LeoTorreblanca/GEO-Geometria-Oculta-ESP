...
/** GEO_CLASS parameter: geo_xi */
class_call(parser_read_double(pfc,"geo_xi",&ppt->geo_xi,&flag1,errmsg),
           errmsg,
           errmsg);
...
class_call(parser_read_double(pfc,"geo_mu",&ppt->geo_mu,&flag1,errmsg),
           errmsg,
           errmsg);
...
class_call(parser_read_int(pfc,"geo_mode",&ppt->geo_mode,&flag1,errmsg),
           errmsg,
           errmsg);
