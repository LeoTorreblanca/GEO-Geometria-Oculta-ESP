...
Este repositorio busca mostrar el experimento **GEO_CLASS** de forma **limpia, reproducible, auditable, ejecutable y falsable**.

El objetivo **NO** es afirmar una validación física definitiva, sino permitir que cualquier interesado pueda:
* Ejecutar el entorno.
* Reproducir los gráficos.
* Verificar los resultados numéricos.
* Comparar contra $\Lambda$CDM.
* Analizar la geometría emergente y auditar el código.
